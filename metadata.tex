...
language into which Juvix desugars. We provide a precise and abstract
...
implementation is discussed and the role of JuvixCore
in the Juvix compilation pipeline is explained. Finally, we compare the language
