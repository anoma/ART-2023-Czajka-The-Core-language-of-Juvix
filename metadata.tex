...
language into which Juvix desugars. We provide an abstract yet precise
specification of JuvixCore's syntax, evaluation semantics, and optional
type system. The correspondence between this specification and the actual
implementation is discussed, along with an explanation of JuvixCore's role
in the Juvix compilation pipeline. Finally, we compare the language
