...
In our treatment of binders we have eluded the issues with renaming and variable capture, working implicitly up to $\alpha$-conversion as is standard in textual presentation of lambda-calculi. In the implementation
